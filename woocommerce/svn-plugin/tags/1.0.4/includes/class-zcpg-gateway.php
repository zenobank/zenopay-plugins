...
class ZCPG_Gateway extends WC_Payment_Gateway
{
    ...
    {
        // Cambia este ID si subes un nuevo tutorial
        $video_id = 'xZVmgBSqfPY';
        $embed_url = sprintf(
            'https://www.youtube.com/embed/%s?rel=0&modestbranding=1',
        ...
        // Bloque del tutorial (responsivo)
        echo '<div class="zcpg-video-wrapper">';
        echo '<iframe src="' . esc_url($embed_url) . '" loading="lazy" allowfullscreen title="Zeno Crypto Gateway Tutorial" frameborder="0"></iframe>';
        echo '</div>';

        // Estilos mínimos para que sea responsive en el admin
        echo '<style>
            .zcpg-video-wrapper{position:relative;padding-bottom:56.25%;height:0;margin:12px 0 18px;border-radius:8px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.06);}
            .zcpg-video-wrapper iframe{position:absolute;inset:0;width:100%;height:100%;border:0;}
        </style>';

...
class ZCPG_Gateway extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->get_option(
            'description',
            esc_html__('Pay securely using USDT, USDC or USDe.', 'zeno-crypto-payment-gateway')
        );
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'description'  => array(
                ...
                'type'    => 'textarea',
                'default' => __('Pay securely using USDT, USDC or USDe.', 'zeno-crypto-payment-gateway'),
            ),
        );
    }
